...
function fetchUser() {
  ...
  fetch(apiUrl)
    ...
    .finally(() => {
      ...
      // Fetch repositories for the new user after user details are loaded
      fetchRepos(currentPage);
      // Update pagination after fetching new repositories
      updatePagination();
    });
}
...
function searchRepositories() {
  ...
  const repoSearchBarContainer = document.getElementById(
